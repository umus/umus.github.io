...
POSTS = (
    ("posts/*.rst", "log", "post.tmpl"),
    ("posts/*.txt", "log", "post.tmpl"),
    ("posts/*.html", "log", "post.tmpl"),
)
PAGES = (
...
REDIRECTIONS = [("log/last-session.html","20161028-ut-mat157mat240-study-session-iii.html"),
                ("log/last-notice.html", "20161103-ut-mat157mat240-friday-session-vote-results.html")]
...
#href="mailto:{email}">{author}</a> - Powered by <a
...
POSTS = POSTS + (("posts/*.org", "log", "post.tmpl"),("posts/*.md", "log", "post.tmpl"),)
